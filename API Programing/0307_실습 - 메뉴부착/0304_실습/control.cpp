...
//메뉴 선택
void  con_SelectMenuColor(HWND hwnd, int id)
{
	switch (id)
	{
		//색상(RGB)
	case ID_40002 :	g_curshape.color = RGB(255, 0, 0); break;
	case ID_40003:	g_curshape.color = RGB(0, 255, 0); break;
	case ID_40004:	g_curshape.color = RGB(0, 0, 255); break;
	}
	InfoUpdate(hwnd, FALSE);
}