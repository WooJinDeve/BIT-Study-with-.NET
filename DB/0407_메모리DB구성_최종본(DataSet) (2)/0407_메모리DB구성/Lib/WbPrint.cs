...
namespace _0407_메모리DB구성
{
    static class WbPrint
    {
        ...
        public static ConsoleKey MenuPrint()
        {
            ...
            Console.WriteLine("[F6]  입금");
            Console.WriteLine("[F7]  출금");
            Console.WriteLine("[F8]  계좌삭제");
            Console.WriteLine("[F9]  저장");
            Console.WriteLine("[F10] 불러오기");
            Console.WriteLine("[C] 트랜젝션테스트(Commit)");
            Console.WriteLine("[R] 트랜젝션테스트(Rollback)");
